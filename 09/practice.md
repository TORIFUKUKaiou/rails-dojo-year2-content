...
AWSの操作は、最初は手順をなぞるだけになりがちです。

「何をやっているのか分からなかった」と感じた人は、もう一度、同じ演習に挑戦してみましょう。

2回目は、できるだけ手順を見ずに進めてみてください。
途中で分からなくなったところが、自分にとっての復習ポイントです。

「完璧だ！」と思える人は、さらに力をつけるために [Stretch](stretch.md) へ進みましょう。
