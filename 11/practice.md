...
## Step 27：リソースを残してStretchへ進む

Practiceで作成した次のリソースは削除しません。

- CloudFormationスタック
- VPCと2つのpublic subnet
- EC2インスタンス
- EC2用セキュリティグループ
- ALB用セキュリティグループ
- ターゲットグループ
...
Rails serverも起動したままにします。

次の[Stretch](stretch.md)では、この構成へ異なるAvailability ZoneのEC2をもう1台追加します。

> [!IMPORTANT]
> ALB、ターゲットグループ、CloudFormationスタックを削除すると、Stretchを続けられません。
> この画面まで確認できたら、リソースを残したままStretchへ進んでください。
...
- [ ] Rails serverとAWSリソースを残したままStretchへ進む準備ができた
