...
3周する理由は、何度も役割を交代しながら反復することで、Git開発の自然なリズムをチーム全員が自分たちのものにするためです。

- 代表者だけでなく、全員が「自分で操作できる」状態を作る
- branch、PR、レビュー、merge の一連のサイクルを繰り返し見て感覚を掴む
- どの役割になっても、迷わずスムーズに動けるようになる
- 後期の本番のチーム開発へ向けて、今から基本フローを手に馴染ませておく
